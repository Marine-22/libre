...
public class WorkerModel extends IntegrationEntityModel implements IWorkerModel {
    ...
    public void prepareForCreate(boolean virtual) {
        ...
        worker.setTypeOfWorkHours(new HashSet<TypeOfWorkHours>());
    ...
    public void initTypeOfHours(Worker o) {
    	LOG.info("initTypeOfHours");
    	if(worker.getTypeOfWorkHours() == null){
    		LOG.info("initTypeOfHours - vytvaram novy type of hours");
